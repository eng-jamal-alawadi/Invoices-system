...
@section('title', ' برنامج الفواتير | المنتجات')
@section('css')
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-outline-success btn-sm" data-effect="effect-scale"
                                                    ...
                                                    href="#edit_product" title="تعديل"><i class="far fa-edit"></i></a>

                                                <a class="btn btn-outline-danger btn-sm " data-effect="effect-scale"
                                                    data-id="{{ $product->id }}"
                                                    data-product_name="{{ $product->product_name }}" data-toggle="modal"
                                                    href="#delete_product" title="حذف"><i class="far fa-trash-alt"></i></a>
                ...
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_name" id="name" class="form-control" placeholder=""
